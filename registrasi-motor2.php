            ...
            <div class="card-body">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" placeholder="Masukkan merek motor, cth: Yamaha" class="form-control" id="merk_motor"
                                name="merk_motor" value="<?php echo $merk_motor ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" placeholder="Masukkan " class="form-control" id="nama_motor"
                                name="nama_motor" value="<?php echo $nama_motor ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="harga_motor" name="harga_motor">
                                ...
                                <option value="Rp. 0 - 5.000.000" <?php if ($harga_motor=="Rp. 0 - 5.000.000")
                                    echo
                                    "selected" ?>>Rp. 0 - 5.000.000</option>
                                <option value="Rp. 5.000.000 - 10.000.000" <?php if ($harga_motor=="Rp. 5.000.000 -
                                    10.000.000")
                                    echo "selected" ?>>Rp. 5.000.000 - 10.000.000</option>
                                <option value="Rp. 10.000.000 - 20.000.000" <?php if ($harga_motor=="Rp. 10.000.000 -
                                    20.000.000")
                                    echo "selected" ?>>Rp. 10.000.000 - 20.000.000</option>
                                <option value="Rp. 20.000.000 - 30.000.000" <?php if ($harga_motor=="Rp. 20.000.000 -
                                    30.000.000")
                                    echo "selected" ?>>Rp. 20.000.000 - 30.000.000</option>
                                <option value="Rp. 30.000.000 - 40.000.000" <?php if ($harga_motor=="Rp. 30.000.000 -
                                    40.000.000")
                                    echo "selected" ?>>Rp. 30.000.000 - 40.000.000</option>
                                <option value="Rp. 40.000.000 - 50.000.000" <?php if ($harga_motor=="Rp. 40.000.000 -
                                    50.000.000")
                                    echo "selected" ?>>Rp. 40.000.000 - 50.000.000</option>
                                <option value="Rp. 50.000.000 - 60.000.000" <?php if ($harga_motor=="Rp. 50.000.000 -
                                    60.000.000")
                                    echo "selected" ?>>Rp. 50.000.000 - 60.000.000</option>
                                <option value="Rp. 60.000.000 - 70.000.000" <?php if ($harga_motor=="Rp. 60.000.000 -
                                    70.000.000")
                                    echo "selected" ?>>Rp. 60.000.000 - 70.000.000</option>
                                <option value="Rp. 70.000.000 - 80.000.000" <?php if ($harga_motor=="Rp. 70.000.000 -
                                    80.000.000")
                                    echo "selected" ?>>Rp. 70.000.000 - 80.000.000</option>
                                <option value="Rp. 80.000.000 - 90.000.000" <?php if ($harga_motor=="Rp. 80.000.000 -
                                    90.000.000")
                                    echo "selected" ?>>Rp. 80.000.000 - 90.000.000</option>
                                <option value="Rp. 90.000.000 - 100.000.000" <?php if ($harga_motor=="Rp. 90.000.000 -
                                    100.000.000")
                                    echo "selected" ?>>Rp. 90.000.000 - 100.000.000</option>
                                <option value="Rp. 100.000.000+" <?php if ($harga_motor=="Rp. 100.000.000+")
                                    echo
                                    "selected" ?>>> Rp. 100.000.000</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
